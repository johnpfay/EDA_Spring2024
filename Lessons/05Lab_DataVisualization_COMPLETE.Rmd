...
PeterPaul.chem.nutrients %>% 
  filter(depth == 0) %>% 
  ggplot(aes(x=daynum,temperature_C,color=year4))+
  geom_point()+
...
PeterPaul.chem.nutrients %>% 
  ggplot(aes(x=sampledate,temperature_C,color=depth)) +
  geom_point(size=0.5) +
  scale_color_viridis(option='magma',direction = -1,name='Depth (m)') +
  scale_x_date(
    date_break='5 years',
    date_labels = '%Y')
